...
if ( ! function_exists( 'ripple_wp_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function ripple_wp_posted_on() {
...
if ( ! function_exists( 'ripple_wp_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'ripple_wp_entry_footer' ) ) :
	/**
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'ripple-wp' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'ripple_wp_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function ripple_wp_post_thumbnail() {
